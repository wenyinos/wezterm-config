...
- [**GPU Adapter Selector**](https://github.com/KevinSilvester/wezterm-config/blob/master/utils/gpu_adapter.lua)
  ...
  2. <details>
     ...
     > See: [https://github.com/gfx-rs/wgpu#supported-platforms](https://github.com/gfx-rs/wgpu#supported-platforms) for more info
     >
...
- ##### Requirements:
  ...
  - <details>
    ...
    **Windows**
    ...
    > See issue [https://github.com/wez/wezterm/issues/5166](https://github.com/wez/wezterm/issues/5166) for more details
    >
